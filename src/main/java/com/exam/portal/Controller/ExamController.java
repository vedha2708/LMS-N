...
public class ExamController {
    ...
    public String showExams(Model model, Principal principal){
      ...
      AdminUser org=adminuserrepo.findByEmail(principal.getName()); 
      if(org != null){
    ...
    public String createExam(Exam exam, Principal principal){
        Object user=SecurityContextHolder.getContext().getAuthentication().getPrincipal();
    ...
    public String editSaveExam(Exam exam){
        ...
        exam.setAdminuser(exam1.getAdminuser());
        repo.save(exam);
        return "redirect:/organiser/exams";
    }
    ...
    public String sendEmail(@RequestParam(name = "id",required = true ) Long id, RedirectAttributes redirectAttributes) throws MessagingException, jakarta.mail.MessagingException {
